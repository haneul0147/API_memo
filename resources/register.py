...
class UserRegisterResource(Resource):
    def post(self):
        ...
        #{"email":"lol123@naver.com",
        #"password":"1234","nickname":"오늘 뭐먹지"}
        
        # 2. 이메일 주소가 제대로 된 주소인지 확인하는 코드 
        #    잘못된 이메일 주소면, 잘못됬다고 응답한다.
        try:
            # Validate.
        ...
        try:
            ...
            print('Error',e )
            # 6. username이나 eamli이 이미 DB에 있으면,
